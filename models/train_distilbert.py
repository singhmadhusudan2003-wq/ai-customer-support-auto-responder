...
train_distilbert.py
--------------------
Fine-tunes `distilbert-base-uncased` on the intent classification task
...
Saves the fine-tuned model + tokenizer to models/saved/distilbert_intent/
and appends its metrics to models/saved/metrics_distilbert.json
"""
...
SAVE_DIR = BASE_DIR / "saved" / "distilbert_intent"
...
def main():
    ...
    with open(BASE_DIR / "saved" / "metrics_distilbert.json", "w") as f:
        json.dump(metrics, f, indent=2)

    print("DistilBERT training complete. Metrics saved.")
